...
import VoteTo from '../component/VoteTo'
...
class voteTo extends React.Component {
  ...
  // 根据任务地址 给某人投票
  voteToMember = async(taskAddr, memberAddr)=> {
    ...
    try{
      ...
      .voteTo(memberAddr).send({from: _account, gas: "4700000"})
      .then(function(result){
        console.log(result);
        alert("vote to sucessfully.")
      })
    }
    catch(error){
      console.error(error);
      alert("You can't vote. Maybe there's something error. You can open the console for detail.")
    }
  }
  ...
  transferMsg(msg){
    console.log(msg)
    this.voteToMember(msg.taskAddr, msg.memberAddr);
  }
        ...
        <div className={classes.root}>
          ...
          <div className={classes.appContent}>
            ...
            <main className={classes.mainContent}>
                <VoteTo transferMsg = {msg => this.transferMsg(msg)}/>
            </main>
          </div>
        </div>
      </MuiThemeProvider>
