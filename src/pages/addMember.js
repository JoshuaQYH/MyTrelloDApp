...
class addMember extends React.Component {
  ...
  add = async(name, memberAddr, contact)=>{
    ...
    try{
      ...
      .addStaff(memberAddr, name, contact).send({from: _account, gas: "4700000"})
  ...
  transferMsg(msg){
    console.log(msg)
    this.add(msg.name, msg.memberAddr, msg.contact)
      ...
      <MuiThemeProvider theme={theme}>
        <div className={classes.root}>
          ...
          <div className={classes.appContent}>
            ...
            <InputMember  transferMsg = {msg => this.transferMsg(msg)}/>
            </main>
          </div>
        </div>
      </MuiThemeProvider>
